...
which decomposes the Linden reference specification into independently-verified
layers:

```
linden-warblre                      ← you are here (leaf)
  └─ linden-semantics-core          backtracking-tree semantics
